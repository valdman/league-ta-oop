...
// console.log({ isSame: myArray === myArray2 });
...
console.log({result: calculateStateDiff(cachedState.items[3], state.items[3])});
console.log({result: calculateStateDiff(cachedState.items[3].comments, state.items[3].comments)});
console.log({result: calculateStateDiff(cachedState.items[3].comments[1], state.items[3].comments[1])});
console.log({result: calculateStateDiff(cachedState.items[3].comments[1].text, state.items[3].comments[1].text)});
